...
const SkillsForm = ({data, onChange}) => {
    ...
    const removeSkill = (indexToRemove)=>{
        onChange(data.filter((__, index)=> index !== indexToRemove))
    }
  ...
  return (
    <div className='space-y-4'>
        ...
        <div className='flex gap-2'>
            ...
            <button onClick={addSkill} disabled={!newSkill.trim} className='flex items-center gap-2 px-4 py-2 text-sm bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-50 disbaled:cursor-not-allowed'>
